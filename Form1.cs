...
{
    private ContexApp? AppDb { get; set; }
    public Form1()
    {
        InitializeComponent();
        AppDb = new ContexApp();
    ...
    private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        var list = (from S in AppDb.Students
        ...
        var list1 = (from S in AppDb.Students
                    where S.FirstName == comboBox1.Text
    ...
    {
        var list = (from S in AppDb.Teachers
    ...
    {
        var list = (from S in AppDb.Books
